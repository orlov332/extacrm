...
public class FormTransferGrid extends ExtaGrid<FormTransfer> {
    ...
    private class FormTransferSecuredContainer extends SecuredDataContainer<FormTransfer> {

        public FormTransferSecuredContainer() {
            super(new FormTransferSecurityFilter());
        }
